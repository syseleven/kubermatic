...
yq w charts/kubermatic-opeator/values.yaml 'kubermaticOperator.image.repository' 'quay.io/kubermatic/kubermatic-ee'
...
git checkout -- LICENSE charts/kubermatic-opeator/values.yaml
